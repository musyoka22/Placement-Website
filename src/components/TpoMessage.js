...
const Messaget = props => (
    <div>
        ...
        <p className='msgp'>The Training and Placement cell of MKU, is an integral part of the academics It helps in shaping the careers of our students in the field of Information Technology. </p><br />
        ...
        <br /><p className='cred' >Dr Ann Njoroge</p>
